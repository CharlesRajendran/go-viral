...
print("Accuracy :",nltk.classify.accuracy(classifier2,testing_set))
...
print(clf.predict(vectorizer.transform(["#Bahubali2 is will be awesome",\
                                        "can't wait for bahubali",\
                                        "#Bahubali2 is released in 8000 theaters",\
                                        "#Bahubali2 team photo shoot photos http://tw..."])\
                  .toarray()))


print("Accuracy :",clf.score(X_test,rf_testing_label))
