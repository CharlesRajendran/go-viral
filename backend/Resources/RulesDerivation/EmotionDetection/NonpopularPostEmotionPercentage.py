...
print("Average Emotion Percentage Of A non-Popular Post : %.2f" %averageEmotionPercentageOfAPopularPost)
print("Average Semantic Orientation Of A non-Popular Post : %.2f" %averageSOOfAPopularPost)
